...
### boxplot viz (no outliers z-score)
...
### correlation viz (no outliers z-score)
...
### models (continuous team_size with outliers)
...
### models (continuous team_size without outliers z-score)
...
### models (team_size_bin with outliers)
...
### models (team_size_bin with no outliers z-score)
